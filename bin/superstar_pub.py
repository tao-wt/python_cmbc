...
def helpFunc(a,b,c,d):
	...
	print "superstar.py -s -a -c start|stop|restart --all --cmd start|stop|restart"
	print "superstar.py -s -i ipaddr,[xx,xx] -c start|stop|restart --ip x1,x2,.. --cmd start|stop|restart"
	print "superstar.py -s -M modulename,[xx,xx] -c start|stop|restart --Mod mod1,mod2 --cmd start|stop|restart"
	print "superstar.py -s -i ipaddr,[xx,xx] -M modulename,[xx,xx] -c start|stop|restart"
	print '''---------------------------------------------------------------------------------------
For examples:
1 for general usage:
